  ...
  return (
    <section className="py-[150px]">
      <div className="container mx-auto">
        ...
        <div className="mt-[50px] flex flex-wrap xl:flex-nowrap justify-between gap-8">
          {posts.map((post) => (
            <div key={post.id} className="w-full md:w-[326px]">
              ...
              <div className="px-[10px] py-[15px]">
                <Link href={`/blog/${post.slug}`}><h1 className="text-xl font-semibold text-white hover:text-primary-500 transition-all break-all">{post.title.slice(0, 27)}</h1></Link>
